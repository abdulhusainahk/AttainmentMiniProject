...
class TeachingScheme(models.Model):
    Code_patt = models.OneToOneField(Employee, on_delete=models.CASCADE)
...
class DeliveryMethods(models.Model):
    Code_patt = models.OneToOneField(Employee, on_delete=models.CASCADE, primary_key=True)
...
class CoPoMapp(models.Model):
    CO_id = models.OneToOneField(CO, on_delete=models.DO_NOTHING, primary_key=True)
    VPO1 = models.IntegerField(choices=pochoice, )
    VPO2 = models.IntegerField(choices=pochoice)
    VPO3 = models.IntegerField(choices=pochoice)
    VPO4 = models.IntegerField(choices=pochoice)
    VPO5 = models.IntegerField(choices=pochoice)
    VPO6 = models.IntegerField(choices=pochoice)
    VPO7 = models.IntegerField(choices=pochoice)
    VPO8 = models.IntegerField(choices=pochoice)
    VPO9 = models.IntegerField(choices=pochoice)
    VPO10 = models.IntegerField(choices=pochoice)
    VPO11 = models.IntegerField(choices=pochoice)
    VPO12 = models.IntegerField(choices=pochoice)
...
class Report(models.Model):
    ...
    VPO1 = models.FloatField(null=True, blank=True)
    VPO2 = models.FloatField(null=True, blank=True)
    VPO3 = models.FloatField(null=True, blank=True)
    VPO4 = models.FloatField(null=True, blank=True)
    VPO5 = models.FloatField(null=True, blank=True)
    VPO6 = models.FloatField(null=True, blank=True)
    VPO7 = models.FloatField(null=True, blank=True)
    VPO8 = models.FloatField(null=True, blank=True)
    VPO9 = models.FloatField(null=True, blank=True)
    VPO10 = models.FloatField(null=True, blank=True)
    VPO11 = models.FloatField(null=True, blank=True)
    VPO12 = models.FloatField(null=True, blank=True)
